...
Special case "compressor" for LL2 that bypasses quantization and encoding.
Receives 32-bit wavelet output data from 16 vertical wavelet cores and writes
raw 10b LL2 data to a 128-bit wide FIFO. The RAM  writer reads from this FIFO 
as needed based on the fill level.

Care is taken to match the latency of compressor_16in (which does include
quantization and encoding) so that the LL2 output stream is in sync with the
HL2, HL2, and LH2 streams.
=================================================================================
*/

module compressor_LL2
(
    input wire px_clk,
...
reg [63:0] q_4px_concat_H;
reg [63:0] q_4px_concat_L;

// Emulate: "Instantiate two 4x16b quantizers for the high and low data."
...
reg [63:0] e_4px_H;
reg [63:0] e_4px_L;
wire [6:0] e_len_H = 7'd40;   // LL2 always 10b raw.
wire [6:0] e_len_L = 7'd40;   // LL2 always 10b raw.
