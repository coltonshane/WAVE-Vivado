...
/*
=================================================================================
Encoder_v1_0_M00_AXI.v
AXI Master controller for writing data to PS DDR4 from the quantizer/encoder.
Modified from AXI peripheral template to be write-only and not wait for
write responses from burst N to initiate burst N+1.
=================================================================================
*/

module Encoder_v1_0_M00_AXI 
#(
...
(
    ...
    // Signal to IP that a transaction is in progress.
    // TO-DO: Combine this with mst_exec_state.
    output reg axi_busy,
	// -----------------------------------------------------------------------------------------------------
