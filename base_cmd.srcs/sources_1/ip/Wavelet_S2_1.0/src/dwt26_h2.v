`timescale 1ns / 1ps
/* =================================================================================================
Discrete Wavelet Transform 2/6 Core, Horizontal Second Stage (dwt26_h2.v)

Lifting core for 2/6 DWT in the horizontal dimension (across a row) on the second stage.
