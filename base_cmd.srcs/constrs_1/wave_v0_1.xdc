...
set_property PACKAGE_PIN A12 [get_ports uart0_txd]
set_property IOSTANDARD LVCMOS33 [get_ports uart0_txd]
set_property PACKAGE_PIN A11 [get_ports uart0_rxd]
...
# GPIO user outputs (3.3V).
set_property PACKAGE_PIN B11 [get_ports {gpio_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[0]}]
set_property PACKAGE_PIN A10 [get_ports {gpio_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[1]}]
set_property PACKAGE_PIN F12 [get_ports {gpio_o[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[2]}]
set_property PACKAGE_PIN F11 [get_ports {gpio_o[3]}]
...
set_property PACKAGE_PIN B10 [get_ports {cmv_control[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cmv_control[1]}]
set_property PACKAGE_PIN D12 [get_ports {cmv_control[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cmv_control[2]}]
set_property PACKAGE_PIN C12 [get_ports {cmv_control[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {cmv_control[3]}]
